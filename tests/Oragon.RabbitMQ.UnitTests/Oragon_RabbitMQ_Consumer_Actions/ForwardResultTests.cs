...
public class ForwardResultTests
{
    ...
    public async Task ExecuteAsync_MustCallBasiPublishWithCorrelationId()
    {
        ...
        ForwardResult<ResponseDTO> result = AmqpResults.Forward(exchange, routingKey, true, new ResponseDTO() { Name = "Text1", Age = 4 });
    ...
    public async Task ExecuteAsync_MustCallBasiPublishWithReplyTo()
    {
        ...
        ForwardResult<ResponseDTO> result = AmqpResults.Forward(exchange, routingKey, true, replyTo, new ResponseDTO() { Name = "Text1", Age = 4 });
    ...
    public async Task ExecuteAsync_MustCallBasiPublishManyTimes()
    {
        ...
        ForwardResult<ResponseDTO> result = AmqpResults.Forward(exchange, routingKey, true,
