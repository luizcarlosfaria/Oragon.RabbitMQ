...
internal sealed class ConfigurationSchemaAttribute(string path, Type type, string[] exclusionPaths = null) : Attribute
{
...
internal sealed class LoggingCategoriesAttribute(params string[] categories) : Attribute
{
    ...
    /// </summary>
    public string[] Categories { get; internal set; } = categories;
}
